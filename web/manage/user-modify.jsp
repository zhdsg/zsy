...
<div id="main" class="wrap">
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				<dt>用户管理</dt>
				<dd><em><a href="/manage/user-add.jsp">新增</a></em><a href="/manageUser.servlet?action=load">用户管理</a></dd>
				<dt>商品信息</dt>
	...
	<div class="main">
		<h2>修改用户</h2>
		<div class="manage">
			<form action="/manageUser.servlet?action=update&id=${user.euUserId}" method="post">
				<table class="form">
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="text" name="passWord" value="${user.euPassword}" /></td>
					</tr>
					<tr>
